class LearningCamera extends Camera;
...
var const LearningCameraProperties CameraProperties;
...
defaultproperties
{
	CameraProperties=LearningCameraProperties'Learning.Camera.LearningCameraProperties'
}